...
class CliParser:
    ...
    def setup_subcommands(self) -> None:
        ...
        # CPG command
        cpg_parser = subparsers.add_parser("cpg", help="Generate Code Property Graph from C source code")
        ...
        # Template command
        template_parser = subparsers.add_parser("template", help="Generate Template artifacts from CPG data")
        ...
        template_parser.add_argument("--workers", default="1", help="Number of parallel workers (default: 1)")
        ...
        # AST command
        ast_parser = subparsers.add_parser("ast", help="Generate Abstract Syntax Tree from Template data")
        ...
        ast_parser.add_argument("--workers", default="1", help="Number of parallel workers (default: 1)")
        ...
        tf_parser.add_argument("--workers", default="1", help="Number of parallel workers (default: 1)")
        ...
        # DFG command
        dfg_parser = subparsers.add_parser("dfg", help="Generate Data Flow Graph from Template data")
        ...
        dfg_parser.add_argument("--workers", default="1", help="Number of parallel workers (default: 1)")
        ...
        # Full command
        full_parser = subparsers.add_parser("full", help="Generate Full artifacts from Template data")
        ...
        full_parser.add_argument("--workers", default="1", help="Number of parallel workers (default: 1)")
